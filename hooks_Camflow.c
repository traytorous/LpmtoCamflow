...
/*
Tray Keller Comment -> These are the hooks from lpm. This enables camflow to mess with the networking stuff
// Exporting all of this to hooks files
*/
...
static struct security_hook_list provenance_hooks[] __lsm_ro_after_init = {
    ...
    // Tray Keller - Add hooks for netfilter here for socket_setsockopt and socket_getsockopt
